    ...
    Partial Public Class reporte_orden_produccionTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT OP_ID, FECHA, OPD_ID, CLIENTE, USUARIO, MEDIDA, GRAMAJE, PESO_SOL, PESAJE "& _ 
                "FROM dbo.reporte_orden_produccion "
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As prwpDataSet1.reporte_orden_produccionDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As prwpDataSet1.reporte_orden_produccionDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As prwpDataSet1.reporte_orden_produccionDataTable = New prwpDataSet1.reporte_orden_produccionDataTable()
